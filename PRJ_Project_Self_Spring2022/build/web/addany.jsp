...
<html>
    <head>
        ...
        <title>PM Shoes Shop | Add Product/Category/Shipper</title>
    ...
    <body>
        ...
        <c:if test="${requestScope.pro != null}">
            <h2 class="text mar">Add Products Form</h2>                    
            <div class="text mr-auto ml-auto form">
                <h3 class="text" style="color: red">${requestScope.err}</h3>
                <form action="addany" method="post">
                    <input type="hidden" name="n" value="pro"/>
                    Enter Name: &nbsp;<input type="text" name="name" placeholder="enter name" value="" /><br/>
                    Category:<br/>
                    <c:forEach items="${requestScope.allcate}" var="cat">
                    <input type="radio" name="cid" value="${cat.id}">&nbsp;${cat.name}<br/>
                    </c:forEach>
                    Enter Image: &nbsp;<input type="text" name="image" placeholder="enter absolute url" value=""/><br/>
                    Enter Price: &nbsp;&nbsp;&nbsp;<input type="text" name="price" placeholder="..." value=""/><br/>
                    Enter Stock: &nbsp;&nbsp;&nbsp;<input type="text" name="stock" placeholder="..." value=""/><br/>
                    Enter Detail: &nbsp;&nbsp;<input type="text" name="detail" placeholder="enter detail" value=""/><br/><br/>
                    <input id='button' style="color: white" type="submit" value="Add"/>
                </form> 
            </div>
            <div class="text">
        ...
        <c:if test="${requestScope.cate != null}">
            <h2 class="text mar">Add Category Form</h2>                    
            <div class="text mr-auto ml-auto form">
                <h3 class="text" style="color: red">${requestScope.err}</h3>
                <form action="addany" method="post">
                    ...
                    Enter Name: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="name" placeholder="enter name" value="" /><br/>
                    Enter Image:  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="image" placeholder="enter absolute url" value=""/><br/>
                    Enter Describe: &nbsp;<input type="text" name="detail" placeholder="enter detail" value=""/><br/><br/>
                    <input id="button" style="color: white" type="submit" value="Add"/>
                </form> 
            </div>
            <div class="text">
         ...
         <c:if test="${requestScope.ship != null}">
            <h2 class="text mar">Add Shipper Form</h2>                    
            <div class="text mr-auto ml-auto form">
                <h3 class="text" style="color: red">${requestScope.err}</h3>
                <form action="addany" method="post">
                    <input type="hidden" name="n" value="ship"/>
                    Enter Name: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="name" placeholder="enter name" value="" /><br/>
                    Enter Phone:  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="phone" placeholder="enter phone" value=""/><br/>
                    Choose Status: &nbsp;<input type="radio" name="sta" value="1" checked/> On <input type="radio" name="sta" value="0"/> Off<br/><br/>
                    <input id="button" style="color: white" type="submit" value="Add"/>
                </form> 
            </div>
            <div class="text">
