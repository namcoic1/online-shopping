<%-- 
    Document   : checkout
    Created on : Mar 11, 2022, 4:37:58 PM
    Author     : Dell
--%>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
            <a
                ...
                <i id="home" style="font-size: medium;">Shop</i></a>
            <button
        ...
        <h2 class="text" style="margin: 8% 0 3% 0;">Checkout Form</h2>                    
        <div  class="form mr-auto ml-auto" style="display: flex; justify-content: center">
            ...
            <table>
                <tr>
                    <td>Contact Name: </td>
                    <td><input type="text" value="${ac.name}" disabled/></td>
                </tr>
                <tr>
                    <td>Phone: </td>
                    <td><input type="text" value="${ac.phone}" disabled/></td>
                </tr>
                <tr>
                    <td>Ship Address: </td>
                ...
                <tr>
                    <td>Shippers: </td>
                    <td><select name="shi" style="width: 100%; padding-left: 2%">
                        <c:forEach items="${requestScope.allship}" var="shi">
                            <option value="${shi.id}" ${shi.status eq 'false'?"disabled":""}>&nbsp;${shi.name}</option><br/>
                        </c:forEach>
                    </select></td>
                </tr>
                <tr> 
                    <td>Total: </td>
                    <td><input type="text" value="$${requestScope.total}" disabled/></td>
                </tr>
                <tr>
                    <td></td>
                    <td><input id="button" style="color: white" type="submit" value="Confirm"/></td>
                </tr>
        ...
        <div class="text">
            <a type="button" style="margin-top: 2%; text-decoration: none" href="shopcart">&leftarrow;<span class="text-muted"> Back to cart</span></a>
        </div> 
